        ...
        <Grid>
          <Grid.Row columns={2}>
            <Grid.Column textAlign="center">
              ...
              <Button icon onClick={handleSavePassword}>
                <Icon name="save" />
              </Button>
              <Button icon onClick={handleCopyToClipBoard}>
                <Icon name="copy" />
              </Button>
              <Button icon onClick={handleGenerate}>
                <Icon name="refresh" />
              </Button>
            </Grid.Column>
            <Grid.Column>
              <Form>
                ...
                <Form.Field>
                  <Checkbox
                    ...
                    onChange={(_, data) =>
                      setIncludeNumbers(data.checked ? data.checked : false)
                    }
                  />
                </Form.Field>
                <Form.Field>
                  <Checkbox
                    ...
                    onChange={(_, data) =>
                      setIncludeLowercase(data.checked ? data.checked : false)
                    }
                  />
                </Form.Field>
                <Form.Field>
                  <Checkbox
                    ...
                    onChange={(_, data) =>
                      setIncludeUppercase(data.checked ? data.checked : false)
                    }
                  />
                </Form.Field>
                <Form.Field>
          ...
          {savedPasswords.map((pass, index) => (
            <Card key={index}>
              <Card.Content>
                ...
                <Card.Description>
                  <Button icon onClick={() => handleSavedPasswordDelete(pass)}>
                    <Icon name="trash" />
                  </Button>
                </Card.Description>
              </Card.Content>
